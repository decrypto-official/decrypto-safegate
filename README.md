...
**Status: v0.1.6.** Ethereum and Solana, a 17-pattern dictionary, a 20-token registry, a CLI and a dashboard. Methodology 0.1.0. Changes are tracked in [UPDATE.md](UPDATE.md).
