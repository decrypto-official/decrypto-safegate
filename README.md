...
**Status: v0.1.8.** Ethereum and Solana, a 23-pattern dictionary, a 21-token registry, a CLI and a dashboard. Methodology 0.1.0. Changes are tracked in [UPDATE.md](UPDATE.md).
